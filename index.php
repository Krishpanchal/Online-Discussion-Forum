    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="https://source.unsplash.com/2400x900/?laptop" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
    ...
    <div class="container my-4" id="ques">
        ...
        <div class="row my-4">
         ...
         while($row = mysqli_fetch_assoc($result)){
          ...
          if($row["image"]){
            $image = '<img src="../forum_admin/images/'. $row['image'] .'" class="card-img-top" alt="..." />';
          }else{
            $image = '<img src="https://source.unsplash.com/500x400/?hacking' . $cat . ',coding" class="card-img-top" alt="..."/>';
          }
